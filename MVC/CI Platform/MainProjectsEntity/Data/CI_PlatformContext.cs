...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=PCA159\\SQL2017;DataBase=CI_Platform;TrustServerCertificate=True;User ID=sa;Password=Tatva@123;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Admin>(entity =>
        {
            entity.HasKey(e => e.AdminId).HasName("PK__admin__43AA41419034FBF0");
        ...
        {
            entity.HasKey(e => e.BannerId).HasName("PK__banner__10373C342ADA7B95");
        ...
        {
            entity.HasKey(e => e.CityId).HasName("PK__city__031491A82604FC26");
        ...
        {
            entity.HasKey(e => e.CmsPageId).HasName("PK__cms_page__B46D5B523CDC9DA2");
        ...
        {
            entity.HasKey(e => e.CommentId).HasName("PK__comment__E795768729B3082A");
        ...
        {
            entity.HasKey(e => e.CountryId).HasName("PK__country__7E8CD055A01D9B16");
        ...
        {
            entity.HasKey(e => e.FavouriteMissionId).HasName("PK__favorite__94E4D8CA5A35B154");
        ...
        {
            entity.HasKey(e => e.GoalMissionId).HasName("PK__goal_mis__358E02C70EC0ED32");
        ...
        {
            entity.HasKey(e => e.MissionId).HasName("PK__mission__B5419AB2570522B0");
        ...
        {
            entity.HasKey(e => e.MissionApplicationId).HasName("PK__mission___DF92838AF17B0623");
        ...
        {
            entity.HasKey(e => e.MissionDocumentId).HasName("PK__mission___E80E0CC850955067");
        ...
        {
            entity.HasKey(e => e.MissionInviteId).HasName("PK__mission___A97ED158C2FAB00E");
        ...
        {
            entity.HasKey(e => e.MissionMediaId).HasName("PK__mission___848A78E8A0BFEF27");
        ...
        {
            entity.HasKey(e => e.MissionRatingId).HasName("PK__mission___320E517229B7C888");
        ...
        {
            entity.HasKey(e => e.MissionSkillId).HasName("PK__mission___8271200893DF2728");
        ...
        {
            entity.HasKey(e => e.MissionThemeId).HasName("PK__mission___4925C5AC12C51A07");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__password__3213E83FB24E60D9");
            ...
            entity.Property(e => e.Email)
                .HasMaxLength(191)
                .HasColumnName("email");
            entity.Property(e => e.ResetFlag).HasDefaultValueSql("((0))");
        ...
        {
            entity.HasKey(e => e.SkillId).HasName("PK__skill__FBBA83796F118D2B");
        ...
        {
            entity.HasKey(e => e.StoryId).HasName("PK__story__66339C56B10ED430");
        ...
        {
            entity.HasKey(e => e.StoryInviteId).HasName("PK__story_in__0449786786F8F669");
        ...
        {
            entity.HasKey(e => e.StoryMediaId).HasName("PK__story_me__29BD053C383D1186");
        ...
        {
            entity.HasKey(e => e.TimesheetId).HasName("PK__timeshee__7BBF5068D9DADD1E");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__users__B9BE370F63742469");
        ...
        {
            entity.HasKey(e => e.UserSkillId).HasName("PK__user_ski__FD3B576B98540DEC");
